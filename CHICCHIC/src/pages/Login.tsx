...
const Login = () => {
  ...
  return (
    <div className="font-pretendard flex min-h-screen bg-transparent text-[#AB3130] mb-30">
      ...
      <div className="flex-1 flex mt-30 justify-center px-8">
        <div className="w-full max-w-md">

          <div className="mb-12">
            <h1 className="text-[#AB3130] text-3xl font-normal mb-2">
              <span className="font-crimson">CHICCHIC</span><span className="font-pretendard">에서</span>
            </h1>
            <h2 className="text-[#AB3130] text-3xl  font-normal">
              <span className="font-pretendard">나를 더 </span><span className="font-crimson">CHIC</span><span className="font-pretendard">하게.</span>
            </h2>
          </div>
          ...
          <div>
            <div className="flex items-center mb-6">
              ...
              <span className="px-4 text-[#AB3130] text-sm">SNS 계정으로 로그인</span>
              <div className="flex-1 border-t border-#AB3130"></div>
            </div>
